...
import { CadastroRequestDTO } from '@/src/types/auth';
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <input type="text" name="nomeFazenda" value={formData.nomeFazenda} onChange={handleChange} placeholder="Nome da Fazenda" required className="w-full px-4 py-2 text-gray-900 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" />
                    <input type="text" name="nomeUsuario" value={formData.nomeUsuario} onChange={handleChange} placeholder="Seu Nome Completo" required className="w-full px-4 py-2 text-gray-900 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" />
